...
class Import extends CI_Controller {
  ...
  private function _create_record($xml,$report_id) {
    ...
    $domain_info = $this->_get_domain_info((string)$xml->identifiers->header_from);
  ...
  private function _get_domain_info($domain) {
  ...
  private function _lookup_ip($ip) {
    ...
    $response = $this->_fetch_url("https://dns.google.com/resolve?name=".$lookup_ip."&type=PTR");
